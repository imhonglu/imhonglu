...
|[세이브택스](#2-세이브택스)|2017. 08 ~ 2018. 11|FE, BE, Infra|- 세무기장용 앱 개발(개발 중단)|
| | | |- 홈페이지 개발(https://www.save-tax.co.kr/) |
|[브레인크루](#3-브레인크루)|2018. 11 ~ 2020. 05|FE, BE, Infra|- 학원가용 문자 템플릿 발송 서비스 개발(서비스 종료)|
| | | |- 1:1 케어를 위한 온라인 교육 서비스 개발(https://learnaday.kr/)|
|[주피타카](#4-주피타카)|2020. 06 ~ 2021. 04|FE(lead)|- 소상공인을 위한 가계부 차세대 앱 개발|
...
- 개발환경
  ...
  - batch script
- 경험
  - sendbird 기반의 채팅 기능과 파일 업/다운로드를 제공하는 세무기장용 앱 개발 및 스토어 배포(개발 중단)
  - 윈도우 기반 pc에 원격 관리 프로그램의 설치를 자동화하는 배치 스크립트 작성
  - adb 를 활용한 모바일 웹 매크로 작성
    - 한글 입력시 자소를 분해하여 모바일 키보드를 입력하는 기능 개발
  - 회사 홈페이지 개발
...
- 경험
  ...
  - 학원가용 문자 템플릿 발송 서비스 프로젝트 구조 설계 및 개발(서비스 종료)
  - 1:1 케어를 위한 온라인 교육 서비스 프로젝트 구조 설계 및 개발
...
- 경험
  ...
  - FE 개발문화, 환경 개선 
    - git 컨벤션, 코드 컨벤션 도입
    - PR 기반 코드 리뷰를 도입하여 코드 퀄리티 개선
  - storybook 도입
  - 필요에 따라 font subset 을 손쉽게 바꿀 수 있도록 script 작성
  - mobx factory + class + iife 를 적용하여 특정 데이터 타입에 종속되는 store 생성 함수 제공 
  - 차세대 소상공인용 가계부 앱 구조 설계 및 개발
